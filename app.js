...
const PROFILE_FRAME_UNLOCK_LEVEL = {
  ...
  eldringJakt: 70, frostringJakt: 75, eldFrostCombo: 80, pinball: 85, pinballComet: 86, pinballDuo: 87, allaMinaRamar: 90,
};
...
// ramen dyker upp.
function pinballExtraForFrame(frameKey) {
  if (frameKey === "pinball") return { attrs: ` data-pinball-type="single"`, html: `<span class="pinball-ball"></span>` };
  if (frameKey === "pinballComet") {
    ...
    return { attrs: ` data-pinball-type="comet"`, html: `${trail}<span class="pinball-comet-head"></span>` };
  }
  if (frameKey === "pinballDuo") return { attrs: ` data-pinball-type="duo"`, html: `<span class="pinball-ball pinball-ball-a"></span><span class="pinball-ball pinball-ball-b"></span>` };
  return { attrs: "", html: "" };
}
